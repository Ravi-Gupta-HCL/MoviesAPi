...
namespace MoviesAPI.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        {
            var movieTheaters = await context.MoviTheaters.OrderBy(x => x.Name).ToListAsync();
        ...
        public async Task<ActionResult<List<MovieDTO>>> Filter([FromQuery] FilterMoviesDTO filterMoviesDTO)
        {
            ...
            await HttpContext.InsertParametersPeginationInHelper(moviesQueryable);
            var movies = await moviesQueryable.OrderBy(x => x.Title).Paginate(filterMoviesDTO.PeginationDTO).ToListAsync();
        ...
        public async Task<ActionResult<MoviePutGetDTO>> PutGet(int id)
        {
            ...
            var nonSelectedMovieTheaters = await context.MoviTheaters.Where(x => !movieTheatersIds.Contains(x.Id)).ToListAsync();
